...
extension OnboardingView{
    ...
    private var welcomeSection: some View{
        VStack(spacing: 40){
            ...
            Text("this is the #1 app for finding your match online! In this tutoial we are practicing using appstorage and other swiftUI techniques")
                .fontWeight(.medium)
                .foregroundColor(.white)
                    Spacer()
                    Spacer()
    ...
    Text("What's your gender?")
        ...
        .foregroundColor(.white)
            Picker(selection: $gender,
                ...
                Text("Non-binart").tag("non-binary")
            })
